...
<div class="container fixed w-screen h-screen -z-20">
    ...
    <!--Blob 2-->
    <svg class="fixed left-[640px] top-[70px] blur-[50px]" id="blob2" width="763" height="auto" viewBox="0 0 868 812" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!--Blob 3-->
    <svg class="fixed left-[750px] top-[-60px] blur-[50px]" id="blob3" width="671" height="auto" viewBox="0 0 763 697" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <linearGradient id="paint0_linear_62_18" x1="164.934" y1="469.791" x2="612.792" y2="274.248" gradientUnits="userSpaceOnUse">
                ...
                <stop offset="0.0001" stop-color="#EC1E1E" stop-opacity="0.44"/>
