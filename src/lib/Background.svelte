<div class="fixed left-0 right-0 top-0 -z-20 h-screen w-screen overflow-hidden">
	<svg
		class="absolute -bottom-20 left-1/2 w-[600px] -translate-x-[50%] opacity-70 md:bottom-16 md:w-[920px] lg:-bottom-24 lg:w-[950px] lg:-translate-x-[50%]"
		viewBox="0 0 655 685"
		fill="none"
	...
	>
		<g filter="url(#filter0_f_3_26)">
			<circle
				...
				cy="325.905"
				r="225.5"
				transform="rotate(-45 325.905 325.905)"
		...
		<g filter="url(#filter1_f_3_26)">
			<circle
				...
				cy="222.405"
				r="110"
				transform="rotate(-135 444.405 222.405)"
				fill="url(#paint1_linear_3_26)"
			/>
		</g>
		<g filter="url(#filter2_f_3_26)">
			<circle
				...
				cy="417.126"
				r="167"
				transform="rotate(-21.4188 362.126 417.126)"
				fill="url(#paint2_linear_3_26)"
			/>
		</g>
		<defs>
			<filter
