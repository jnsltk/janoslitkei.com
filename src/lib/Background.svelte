...
<div class="absolute w-screen h-screen -z-20 flex">
    <!--Blob 1-->
    <svg class="fixed left-[520px] top-[40px] blur-[50px]" id="blob1" width="721" height="auto" viewBox="0 0 901 854" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!--Blob 2-->
    <svg class="fixed left-[640px] top-[100px] blur-[50px]" id="blob2" width="694" height="auto" viewBox="0 0 868 812" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!--Blob 3-->
    <svg class="fixed left-[750px] top-[-20px] blur-[50px]" id="blob3" width="610" height="auto" viewBox="0 0 763 697" fill="none" xmlns="http://www.w3.org/2000/svg">
