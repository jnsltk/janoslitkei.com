<div class="fixed -z-20 h-screen w-screen">
	<svg class="absolute -bottom-10 left-1/2 w-[600px] -translate-x-[48%]" width="655" height="685" viewBox="0 0 655 685" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<circle cx="362.126" cy="417.126" r="167" transform="rotate(-21.4188 362.126 417.126)" fill="url(#paint2_linear_3_26)"/>
		</g>
		<defs>
		<filter id="filter0_f_3_26" x="0.405151" y="0.405151" width="651" height="651" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
		<feFlood flood-opacity="0" result="BackgroundImageFix"/>
		<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
		<feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_3_26"/>
		</filter>
		<filter id="filter1_f_3_26" x="234.405" y="12.4051" width="420" height="420" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
		<feFlood flood-opacity="0" result="BackgroundImageFix"/>
		<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
		<feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_3_26"/>
		</filter>
		<filter id="filter2_f_3_26" x="95.0815" y="150.082" width="534.089" height="534.089" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
		<feFlood flood-opacity="0" result="BackgroundImageFix"/>
		<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
		<feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_3_26"/>
		</filter>
