...
<header
	class="z-20 justify-between lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[38.2%] lg:flex-col lg:justify-between lg:py-24"
>
	<div>
		<h1 class="mb-4 text-4xl font-bold tracking-tight text-emphasis md:text-5xl">
