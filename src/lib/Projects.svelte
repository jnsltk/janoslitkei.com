...
<div id="projects" class="text-sm ml-28 pt-[7.25rem] h-screen snap-start">
    <p class="mb-5 mr-16 ">I have worked on a number of projects as part of my studies, and I have done quite a few personal projects as well. Some are web-focused, while others are more general Software Engineering projects. Below are a few of the most important ones.</p>

    <div class="flex overflow-x-scroll hide-scroll-bar">
        <div class="flex flex-nowrap gap-12 py-4 pl-10 snap-x snap-mandatory snap-always overflow-x-auto hide-scroll-bar">
            ...
            <div class=" snap-start scroll-ml-10">
